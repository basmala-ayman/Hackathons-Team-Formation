...
function HowItWorks() {
  ...
  return (
    <div className={`${styles.containerWrapper}  py-4 text-center`}>
      <section className="mb-5">
        <h2 className="fw-bold mb-3" style={{ fontSize: "var(--fs-h2)" }}>How It Works</h2>
        <p className="text-muted" style={{ fontSize: "var(--fs-regular)" }}> Simple steps to build your personalized hackathon team</p>
