...
function ConfirmationModal({ isOpen, actionType, onClose, onConfirm }) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="fw-bold mb-3" style={{ color: 'var(--color-very-dark-purple)', fontSize: 'var(--fs-h4)' }}>
          {title}
        </h3>
        <p className="mb-4" style={{ color: 'var(--color-dark-gray)', fontSize: 'var(--fs-regular)' }}>
          {description}
        </p>
