...
function ConfirmationModal({ isOpen, actionType, onClose, onConfirm }) {
  ...
  // Determine the content based on which button was clicked
  ...
  const description = isSatisfied 
    ? "Are you sure you are satisfied with this team? This will finalize your roster and stop looking for new members."
