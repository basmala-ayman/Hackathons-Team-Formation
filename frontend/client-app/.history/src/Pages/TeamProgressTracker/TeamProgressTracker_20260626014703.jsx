...
function TeamProgressTracker() {
  ...
  return (
   <div 
      className={`py-5 position-relative ${styles.pageBackground}`}
    >
      <div  style={{ maxWidth: '800px' }}>
        
        {/* Header Section */}
        <div className="mb-5 border-bottom pb-4 container" style={{ borderColor: 'var(--color-light-gray) !important' }}>
