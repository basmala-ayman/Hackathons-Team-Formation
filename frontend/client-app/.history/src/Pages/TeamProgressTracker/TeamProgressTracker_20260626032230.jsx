    ...
    <div className={`py-5 min-vh-100 ${styles.pageBackground}`}>
      <div className="container">
        ...
        {teams.length > 0 ? (
          teams.map((team) => (
          <TeamProgressCard 
              key={team.teamId} // Updated to backend schema
              team={{
                ...team,
                // The backend returns a hackathon object, so we safely extract the name
                hackathonName: team.hackathon?.name || "Independent Project"
              }} 
