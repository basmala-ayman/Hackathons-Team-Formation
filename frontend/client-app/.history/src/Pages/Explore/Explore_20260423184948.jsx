...
function Explore() {
  ...
  const handleFilter=useCallback((filterType , selectedValue)=>{
    setFilters((prevFilterState)=>{
      const currentFilterList=prevFilterState[filterType];
      const isSelected=currentFilterList.includes(selectedValue);
      const newValue=isSelected?currentFilterList.filter((item)=>item!==selectedValue):[...currentFilterList, selectedValue]
