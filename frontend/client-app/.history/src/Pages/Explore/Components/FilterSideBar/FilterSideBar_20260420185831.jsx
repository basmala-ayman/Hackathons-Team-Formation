      ...
      {filterSections.map((section)=>(
          <div key={section.id} className="mb-4">
              ...
              <input 
                ...
                // Connects perfectly to our logic from earlier! onChange={() => onFilterChange(section.id, option)} 
              />
              
              <label className="form-check-label text-secondary" htmlFor={`${section.id}-${option}`}>
                {option}
              </label>
