...
import { PrizeIcon , CalenderIcon , LocationIcon } from "../../../../assets/Icons";
  ...
  return (
    <div className={`${styles.hackathonCard} d-flex flex-column  rounded-4 p-3 `}>
      ...
      <div className={`${styles.hackathonDetails}`}>
        <div> <CalenderIcon></CalenderIcon>{date}</div>
        <p> <PrizeIcon color="var(--color-primary-dark)"></PrizeIcon> {prizeAmount}</p>
        <p><LocationIcon></LocationIcon>{location}</p>
        <p>{level}</p>
      </div>
