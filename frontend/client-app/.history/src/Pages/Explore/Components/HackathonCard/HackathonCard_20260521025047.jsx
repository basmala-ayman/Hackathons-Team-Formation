...
function HackathonCard({ hackathon }) {
  ...
  return (
   <div className={`${styles.hackathonCard} d-flex flex-column rounded-4 p-3`}>
      ...
      <div className={`d-flex align-items-center ${styles.badge} ${userCreated ? styles.userCreatedBadge : styles.officialBadge}`}>
        <span><BadgeIcon/></span>
       <span></span> {userCreated ? "USER CREATED" : "OFFICIAL"}
      </div>
