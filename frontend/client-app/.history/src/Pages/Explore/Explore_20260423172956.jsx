...
function Explore() {
  ...
  const filteredHackathons = useMemo(() => {
    ...
    return dummyHackathons.filter((hackathon) => {
      ...
      const filteredSearch = hackathon.title
        .toLowerCase()
    ...
    const filteredDate =
      ...
      filters.categories.length === 0 || filters.categories.includes(hackathon.categories);
       const filteredPrizeRange =
      filters.prizeRange.length === 0 || filters.date.includes(hackathon.prizeRange);
    
  }, [searchWord, dummyHackathons]);
