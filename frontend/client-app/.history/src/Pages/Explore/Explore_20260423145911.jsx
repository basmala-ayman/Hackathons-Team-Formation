      ...
      <Row className="mt-5">
        ...
        <Col lg={10} xs={12}>
          <div className="mb-3">
            ...
            <div className="d-flex align-items-center gap-1 d-lg-none mb-3"
...
<Offcanvas show={openMobileFilterMobileFilters} onHide={handleCloseFilters} placement="start">
  <Offcanvas.Header closeButton>
    <Offcanvas.Title className="fw-bold fs-2">Filters</Offcanvas.Title>
  </Offcanvas.Header>
  <Offcanvas.Body>
    {/* REUSE your component here! */}
    <FilterSideBar />
  </Offcanvas.Body>
</Offcanvas>
</>
