...
function DiscoverProjects() {
    const mockProjects = [
    {
      ...
      description: "Buildtium, dchitectdicta debitis deserunt omnis veritatis corporis qu minus non placeat dolore quammque nihil blanditiis illo. an intelligent system that uses machine learning to monitor environmental changes, predict climate patterns, and provide actionable insights for sustainability initiatives.",
