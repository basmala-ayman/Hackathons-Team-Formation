...
function DiscoverProjects() {
    const mockProjects = [
    {
      ...
      description: "Buildtium, dchitectdicta ing to monitor environmental changes, predict climate patterns, and provide actionable insights for sustainability initiatives.",
