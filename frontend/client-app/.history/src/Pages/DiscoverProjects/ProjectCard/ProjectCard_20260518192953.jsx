...
function ProjectCard({
  ...
  const hasManyRoles = skills.length > 3;


  // If any of our data points exceed our thresholds, show the toggle button
  const canExpand = isTitleLong || isDescLong || hasManySkills;
