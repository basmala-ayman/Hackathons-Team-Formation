          ...
          <div className={`modal-content border-0 p-4 ${styles.roundedModal}`}>
            ...
            <div className="modal-body text-center">
              <div className={`${styles.mainIcon} mx-auto mb-4`}>
                <SparkleIcon color='#fff' size={} />
              </div>

              <h2 className={`fw-bolder mb-2 ${styles.title}`}>Stay Tuned! 🚀</h2>
              <p className="text-secondary mb-0">
                Your team <span className={styles.teamName}>"{teamName || 'Tech Titans'}"</span> has been created successfully
              </p>

              {/* AI Matching Box (Custom Styling) */}
              <div className={`my-4 p-4 ${styles.aiCard}`}>
                <div className="d-flex align-items-center justify-content-center gap-2 mb-2 fw-bold text-dark">
                   <div className={styles.miniIcon}><HiSparkles /></div>
                   AI is Matching Your Team
                </div>
                <p className="small text-muted mb-4">
                  Our intelligent system is finding the perfect teammates based on your skills, interests, and project goals
                </p>
                <div className={`progress ${styles.progressTrack}`} style={{ height: '8px' }}>
                  <div 
              ...
              <CustomButton variant="primary" className="w-100 py-3" onClick={handleGotIt}>
                Got It
              </CustomButton>
            </div>
          </div>
