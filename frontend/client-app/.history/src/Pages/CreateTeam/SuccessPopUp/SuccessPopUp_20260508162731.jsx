        ...
        <div className="modal-dialog modal-dialog-centered modal-lg gap-2">
          <div className={`modal-content border-0 p-5 ${styles.roundedModal}`}>
            ...
            <div className="modal-body text-center">
              ...
              <div className="d-flex align-items-center justify-content-center gap-2 mb-4 text-secondary ">
                <SparkleIcon className="text-success" size={10} color="var(--color-success-green)"/>
