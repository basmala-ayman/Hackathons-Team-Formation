...
function CreateTeam() {
  ...
  const handlePrevStep=()=>{setCurrentStep((curr)=>curr-1)};

  const renderStep = () => {
    switch (currentStep) {
      case 1: return <Step1_TeamBasics formData={formData} setFormData={setFormData} hackathonList={hackathonList} onNext={handleNext} />;
      case 2: return <Step2_AddMembers formData={formData} setFormData={setFormData} onNext={handleNext} onPrev={handlePrev} />;
      case 3: return <Step3_RequiredSkills formData={formData} setFormData={setFormData} onNext={handleNext} onPrev={handlePrev} />;
      case 4: return <Step4_FinalDetails formData={formData} onPrev={handlePrev} />;
      default: return null;
    }
  };
  return (
