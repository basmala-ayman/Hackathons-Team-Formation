...
function Step3_RequiredSkills({ formData, setFormData, onNext, onPrev }) {
  ...
  const loadOptions = (inputValue, callback) => {
    if (!inputValue) {
      callback(skillsData.slice(0, 20)); 
      return;
    }
  ...
  return (
    <div className="d-flex flex-column gap-4">
      ...
      <div className="d-flex flex-column gap-2">
        ...
        <AsyncSelect
          cacheOptions // Remembers previous searches to save time
          defaultOptions // Loads the initial list when they first click the box
