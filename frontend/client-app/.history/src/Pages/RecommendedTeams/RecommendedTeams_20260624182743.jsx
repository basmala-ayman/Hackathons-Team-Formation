            ...
            if (activeTab === "suggested") {
              ...
              return (
                <div
                  ...
                  className="mb-5 p-4 border rounded bg-white shadow-sm"
                >
                  <div className="d-flex justify-content-between align-items-center mb-2 pb-3">
                    <div>
                      <h4
                        className="m-0 fw-bold fs-2"
                        style={{ color: "var(--color-very-dark-purple)" }}
                      ...
                      <p className="text-secondary mt-3 mb-0 fs-4">
                        <strong className="text-dark fs-3">Hackathon Name: </strong>
                    ...
                    <span
                      className={`badge px-3 py-2 bg-light text-primary border border-primary`}
                    >
                      New Invitation
                    </span>
                  </div>
