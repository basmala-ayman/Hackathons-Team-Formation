...
function RecommendedTeams() {
  ...
  const displayedTeams =
    activeTab === "owned" ? recommendations.myTeams
      :  recommendations.join
        
  console.log("myTeams", recommendations.myTeams);
  console.log("join", recommendations.join);

  console.log("all teams", displayedTeams);
