...
const allTeamsDatabase = [
  {
    ...
    maxMembers: 4,
    ownerId: "user-123",
    members: [// 2. Added unique IDs matching your database design
      { id: "u1", name: "Sarah Chen", role: "Team Leader", avatar: "https://via.placeholder.com/150", tags: ["ML/AI", "Python"] },
      { id: "u2", name: "Mike Johnson", role: "Frontend Developer", avatar: "https://via.placeholder.com/150", tags: ["React", "Frontend"] },
      { id: "u3", name: "Lisa Park", role: "Backend Developer", avatar: "https://via.placeholder.com/150", tags: ["Node.js", "Backend"] }
    ],
  },
];
