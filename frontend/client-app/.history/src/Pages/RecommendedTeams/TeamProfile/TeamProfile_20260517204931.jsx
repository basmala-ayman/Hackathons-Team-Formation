...
function TeamProfile() {
  ...
  const buttonLabel = isOwner ? "Send Invitation to the members" : "Request to Join Team";
  
  const handleActionClick = () => {
    if (isOwner) {
      alert("Invitations sent out to recommended match candidates successfully!");
      // Future API: POST to /api/invitations/bulk-send
    } else {
      alert("Application sent! The team owner has been notified.");
      // Future API: POST to /api/teams/join-request
    }
  };
