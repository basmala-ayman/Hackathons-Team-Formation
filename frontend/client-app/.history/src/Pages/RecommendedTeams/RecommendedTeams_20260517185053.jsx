    ...
    <div className={`container py-5`} >
      ...
      <p style={{color:'var(--color-dark-gray)' , fontSize:'var(--fs-regular)'}}>Find the perfect team to join and collaborate on exciting hackathon projects</p>
       ...
       <div className="d-flex gap-3 my-4 flex-wrap">
          <button
            type="button"
            className={`px-5 py-2 fw-medium fs-3 ${activeTab === 'all' ? styles.activeTab : styles.inactiveTab}`}
          ...
          <button
            type="button"
            className={`px-5 py-2 fw-medium fs-3 ${activeTab === 'owned' ? styles.activeTab : styles.inactiveTab}`}
          ...
          <button
            type="button"
            className={`px-5 py-2 fw-medium fs-3 ${activeTab === 'suggested' ? styles.activeTab : styles.inactiveTab}`}
