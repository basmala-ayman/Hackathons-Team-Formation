        ...
        {displayedTeams.length > 0 ? (
          displayedTeams.map((team) => {
            ...
            if (activeTab === "owned") {
              ...
              return (
                <div key={team.teamId} className="mb-5 p-4  rounded bg-white shadow-sm">
                  <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                    <h4 className="m-0 fw-bold" style={{ color: "var(--color-very-dark-purple)" }}>
                      Recommendations for {team.teamName}
                    </h4>
                    ...
                    {recs.map((rec, index) => (
                      <div key={rec.id}>
                        <h6 className="text-secondary mb-2 fw-bold d-flex align-items-center gap-2">
                          <span className="bg-light text-dark px-2 py-1 rounded border">
                            Option {index + 1}
                          </span>
                          {rec.matchLevel && (
                        ...
                        <TeamCard
                          ...
                          members={rec.members} // Show the suggested members for this option
