...
function RecommendedTeams() {
  ...
  const handleAccept = async ({ isOwner, recommendationId, invitationId , teamName }) => {
    ...
    try {
      ...
      if (isOwner) {
        ...
        toast.success(`Congrats for joining the team and you are part of team ${teamName} now`);
  ...
  if (error) {
    return <EmptyState message="No Recommended " />;
  }
