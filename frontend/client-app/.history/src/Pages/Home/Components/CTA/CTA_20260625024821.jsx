  ...
  return (
    <section className="" style={{ background: "var(--color-primary-light-4)", padding:"6rem" }}>
      ...
      <div className={`${styles.ctaBox} shadow text-center px-4 py-5 mx-auto`}>
        ...
        >
          ind the right team, build faster, and make the most of your next hackathon with TeamCatalyst.
        </p>

        <CustomButton variant="primary" size="md" onClick={() => navigate('/create-Team')}>
          Create a Team
        </CustomButton>
      </div>
      </div>
