      ...
      <div className="container">
        <div className={`${styles.ctaBox} shadow text-center px-4 py-5 mx-auto`}>
          <h2 
            ...
            style={{ 
              fontSize: "var(--fs-h2)",
              color: "var(--color-very-dark-purple)" // Applied deep purple
            }}
          >
          ...
          <p
            ...
            style={{
              ...
              maxWidth: "750px",
              color: "var(--color-very-dark-purple)", // Matched heading color family
              opacity: 0.7, // Reduced opacity to create hierarchy instead of using a grey
            }}
          >
