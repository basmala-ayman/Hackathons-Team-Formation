      ...
      <Container className="py-5">
        <Row className="gy-5">
          <Col xs={12} lg={6} className="d-flex flex-column align-items-start">
            ...
            <h1 className={`text-md-center fw-bold mb-4 align-items-md-center ${styles.heroTitle}`}>
              Elevate your hackathon game with{" "}
              <span className={styles.textGradient}>TeamCatalyst</span>
            </h1>
            <p className={`${styles.heroSubTitle} text-md-center fw-medium`}>
              Build the perfect hackathon team using AI-powered skill and
              personality matching.
            </p>
            <Row className="mt-3 w-100 gx-3 gy-5">
