      ...
      <Container className='py-5'>
        <Row className="gy-5">
          ...
          <Col xs={12} lg={6} className="d-flex flex-column align-items-start">
           <div className={`d-inline-flex align-items-center gap-2 px-5 py-2 rounded-pill mb-4 ${styles.badge}`}>
              <Sparkles size={20} />
              <span>AI-powered Platform</span>
            </div>

            <h1 className={`fw-bold mb-4 ${styles.heroTitle}`}>
              Elevate your hackathon game with <span className={styles.textGradient}>TeamCatalyst</span>
            </h1>
