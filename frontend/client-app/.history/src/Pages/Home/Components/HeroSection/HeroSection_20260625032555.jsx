      ...
      <Container className="py-5">
        <Row className="gy-5">
          ...
          >
            ...
            >
              <Sparkles size={20} />
              <span className="text-sm-center d-block w-100 ">
                AI-powered Platform
              </span>
            </div>

            <h1
              className={`text-center text-lg-start fw-bold mb-4  ${styles.heroTitle}`}
            >
            ...
            <p
              className={`${styles.heroSubTitle} text-center text-lg-start fw-medium`}
            >
