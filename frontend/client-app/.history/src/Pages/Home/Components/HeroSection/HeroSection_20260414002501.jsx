      ...
      <Container className="py-5">
        <Row className="gy-5">
          <Col xs={12} lg={6} className="d-flex flex-column align-items-start">
            ...
            <p className={`${styles.heroSubTitle} fw-medium`}>
              Build the perfect hackathon team using AI-powered skill and
              personality matching.
            </p>
            <Row className="w-100 gy-3 gx-3">
              
              {/* xs={12} stacks them on phones. sm={6} splits them 50/50 on small screens and up. */}
              <Col xs={12} sm={6}>
                {/* w-100 forces the button to fill its column completely */}
