      ...
      <Container className="py-5">
        <Row className="gy-5">
          <Col xs={12} lg={6} className="d-flex flex-column align-items-center align-items-lg-start">
            <div
              className={`d-inline-flex align-items-center gap-2 px-5 py-2 rounded-pill mb-4 w-100 ${styles.badge}`}
            >
              <Sparkles size={20} />
              <span className="text-sm-center d-block w-100">AI-powered Platform</span>
            </div>

            <h1 className={`text-sm-center text-lg-start fw-bold mb-4  ${styles.heroTitle}`}>
              Elevate your hackathon game with{" "}
              <span className={styles.textGradient}>TeamCatalyst</span>
            </h1>
            <p className={`${styles.heroSubTitle} text-sm-center text-lg-start fw-medium`}>
