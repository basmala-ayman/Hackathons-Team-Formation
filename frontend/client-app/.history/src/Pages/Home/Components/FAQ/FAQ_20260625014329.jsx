...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, if you add a project idea while creating your team, it will be displayed to users who are interested in the same hackathon so they can explore ideas and potentially become part of your team.",
  },
];
function FAQ() {
  return (
