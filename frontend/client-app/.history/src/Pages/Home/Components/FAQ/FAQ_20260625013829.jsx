...
const FAQ_DATA = [
  {
    id: 1,
    question: "How does this platform help me build a hackathon team?",
    answer:
  ...
  {
    id: 2,
    question: "Do I need to complete my profile before using the platform?",
    answer:
      "Yes. Your profile is one of the most important parts of the matching process. The more accurate your skills, interests, experience, and preferences are, the better the AI can recommend suitable teammates and team options for you.",
  },
   {
    id: 3,
