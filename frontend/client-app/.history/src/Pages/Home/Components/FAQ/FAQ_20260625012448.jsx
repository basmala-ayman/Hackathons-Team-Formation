...
const FAQ_DATA = [
  {
    ...
    answer:
      "It helps you form hackathon teams in different ways, whether you want to create a team request, submit a project idea, or join a hackathon and get matched with suitable teammates.",
  },
  {
    id: 2,
