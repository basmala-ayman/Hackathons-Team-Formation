...
function Discover() {
  ...
  const featuresData = [
    ...
    },
    {
      ...
      description:
        "Define the team you want for your next hackathon.",
    ...
    },
    {
      ...
      description:
        "Share your hackathon idea, attract interested participants, and let AI help build the strongest team around it.",
      bgClass: styles.yellowBg,
      icon: PrizeIcon,
    },
    {
