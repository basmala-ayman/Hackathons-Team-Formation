      ...
      <Container>
        ...
        <Row className="gy-4 mb-5 mt-2">
          ...
          >
            ...
            <p className={`text-dark ${styles.footerSlogan}`}>
             Better teammates. Better builds. Better outcomes.
            </p>
          </Col>
          <Col
            xs={12}
          ...
          >
            <h6
              className={`fw-bolder text-dark mb-3 ${styles.footerSections} `}
            >
              Product
            </h6>
            <Link to="/create-Team" className={styles.footerLink}>
              Create a Team
            </Link>
            <Link to="/explore-Projects" className={styles.footerLink}>
              Find Project Idea
            </Link>
            <Link to="/explore-Hackathons" className={styles.footerLink}>
              Explore Hackathons
            </Link>
          </Col>
          ...
          >
            ...
            <a
              href="mailto:team.catalyst26@gmail.com"
        ...
        <Row className={styles.copyrightRow}>
          <Col className="text-center">
            <p className={`text-dark ${styles.copyRightText}`}>
              © 2026 TeamCatalyst. All rights reserved.
            </p>
          </Col>
        </Row>
      </Container>
