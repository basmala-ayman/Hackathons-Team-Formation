    ...
    <footer className="">
      <Container>
        ...
        <Row className="gy-4 mb-4">
          ...
          <Col xs={12} md={6} lg={3} className="d-flex flex-column align-items-center align-items-lg-start">
            <h6 className="fw-bold text-dark mb-3">Product</h6>
            <Link to="/find-team" className={styles.footerLink}>Find a Team</Link>
            <Link to="/form-team" className={styles.footerLink}>Form a Team</Link>
            <Link to="/explore" className={styles.footerLink}>Explore Hackathons</Link>
          </Col>
