...
function Step1_TeamBasics({ formData, setFormData, onNext, hackathonList }) {
  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.formGroup}>
        <label className={styles.label}>Hackathon Name <span className={styles.asterisk}>*</span></label>
        <Select
          ...
          value={hackathonList.find(option => option.value === formData.hackathonName) || null}
        />
      </div>
